export function getElements() {
    const elements = {
        ...
        recentVisitsList: document.getElementById('recent-visits-list'),
        ...
        waitingGroupAverageValue: document.getElementById('waiting-group-average-value'),
        waitingGroupAverageHint: document.getElementById('waiting-group-average-hint'),
        waitingGroupPositionValue: document.getElementById('waiting-group-position-value'),
        waitingGroupPositionHint: document.getElementById('waiting-group-position-hint'),
        partySizeSelector: document.getElementById('party-size-selector'),
        partySizeOptionButtons: Array.from(document.querySelectorAll('#party-size-options .party-size-card')),
        partySizePrompt: document.getElementById('party-size-modal'),
        partySizePromptOptionButtons: Array.from(document.querySelectorAll('#party-size-modal-options .party-size-card')),
        partySizePromptConfirmBtn: document.getElementById('party-size-modal-confirm'),
        partySizePromptCancelBtn: document.getElementById('party-size-modal-cancel'),
